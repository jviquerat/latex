...
\begin{tikzpicture}[	trim axis left, trim axis right, font=\scriptsize,
	...
	\begin{semilogyaxis}[	xmin=0, xmax=600, scale=0.8,
		...
		\legend{\textsc{bip}}
		% CMAES
		\addplot [upper, forget plot] 					table[x index=0,y index=3] {bip}; 
		\addplot [lower, forget plot] 					table[x index=0,y index=2] {}; 
		\addplot [fill=myblue4, opacity=0.5, forget plot] 		fill between[of=upper and lower];
		\addplot[draw=myblue1, thick, smooth] 			table[x index=0,y index=1] {}; 
